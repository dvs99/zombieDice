...
public class LobbyState : ApplicationStateWithView<LobbyView>
{
    ...
    private void sendChatMessage(string pMessage)
    {
    ...
    private void handleLobbyInfoUpdate(LobbyInfoUpdate pMessage)
    {
        ...
        view.SetLobbyHeading($"Welcome to the Lobby ({pMessage.memberCount} people, {pMessage.readyCount}/{pMessage.maxGameSize} ready)");
    }
